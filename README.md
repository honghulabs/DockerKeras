...
* Images within the repository:  [**honghu/keras**](https://hub.docker.com/r/honghu/keras/)
    ...
    |CNTK| cntk-cu9.2-dnn7.2-py3-18.10  | *CNTK* ```v2.6``` <br/> [*Intel® Distribution for Python*](https://software.intel.com/en-us/distribution-for-python) ```v2018.3.039``` <br/> *Keras* ```v2.2.4```  | [[Click]](https://github.com/chi-hung/DockerKeras/blob/master/Dockerfiles/CNTK/cntk-cu9.2-dnn7.2-18.10.dockerfile) |
