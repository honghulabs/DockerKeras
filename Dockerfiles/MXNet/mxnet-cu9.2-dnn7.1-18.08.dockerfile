...
#   * keras-mxnet
#   * CUDA9.2 + cuDNN7.1 + NCCL2
#
# This image is based on "honghu/intelpython3:cu9.2-dnn7.1-18.08",
...
#################################################################################
FROM honghu/intelpython3:gpu-cu9.2-dnn7.1-18.08
...
ARG MXNET_COMMIT=7261d8c
# commit 7261d8c is in between v1.2.1 and the up-coming v1.3.0.
ARG GLUONCV_COMMIT=1c0886a
# commit 1c0886a is in between v0.2.0 and the up-coming v0.3.0.
...
RUN python3 setup.py install && \
    pip install --no-cache-dir keras-mxnet && \
    rm -rf /tmp/pip* && \
    rm -rf /root/.cache
